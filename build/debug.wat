(module
 ...
 (data $13 (i32.const 720) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (start $~start)
 (func $assembly/index/calculateMoveScore (param $value i32) (result i32)
  local.get $value
  return
 )
 ...
 (func $~lib/typedarray/Int32Array#slice (param $this i32) (param $begin i32) (param $end i32) (result i32)
  ...
  i32.const 0
  i32.store offset=8
  block $"~lib/typedarray/SLICE<~lib/typedarray/Int32Array,i32>|inlined.0" (result i32)
   global.get $~lib/memory/__stack_pointer
   local.get $this
   local.tee $array
   i32.store
   ...
   memory.copy
   local.get $slice
   br $"~lib/typedarray/SLICE<~lib/typedarray/Int32Array,i32>|inlined.0"
  end
  local.set $18
  global.get $~lib/memory/__stack_pointer
  i32.const 12
 ...
 (func $~lib/typedarray/Int32Array#slice@varargs (param $this i32) (param $begin i32) (param $end i32) (result i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/index/moveUp (param $board i32) (param $size i32) (result i32)
  (local $moved i32)
  (local $x i32)
  (local $y i32)
  (local $row i32)
  (local $currentIdx i32)
  (local $targetIdx i32)
  (local $8 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
 ...
 (func $assembly/index/moveRight (param $board i32) (param $size i32) (result i32)
  (local $moved i32)
  (local $y i32)
  (local $x i32)
  (local $col i32)
 ...
 (func $assembly/index/moveDown (param $board i32) (param $size i32) (result i32)
  (local $moved i32)
  (local $x i32)
  (local $y i32)
  (local $row i32)
 ...
 (func $assembly/index/moveLeft (param $board i32) (param $size i32) (result i32)
  (local $moved i32)
  (local $y i32)
  (local $x i32)
  (local $col i32)
 ...
 (func $assembly/index/performMove (param $board i32) (param $size i32) (param $direction i32) (result i32)
  (local $moved i32)
  (local $4 i32)
  (local $5 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/isValidMove (param $board i32) (param $size i32) (param $direction i32) (result i32)
  (local $boardCopy i32)
  (local $moved i32)
  (local $5 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/evaluateBoard (param $board i32) (param $size i32) (result i32)
  (local $score i32)
  (local $emptyCells i32)
  (local $i i32)
  (local $i|5 i32)
  (local $monotonicity i32)
  (local $y i32)
  (local $rowMonotonicity i32)
  (local $x i32)
  (local $prev i32)
  (local $current i32)
  (local $x|12 i32)
  (local $colMonotonicity i32)
  (local $y|14 i32)
  (local $prev|15 i32)
  (local $current|16 i32)
  (local $17 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
   ...
   if
    ...
    loop $for-loop|5
     ...
     if
      ...
      i32.add
      call $~lib/typedarray/Int32Array#__get
      local.set $current|16
      local.get $prev|15
      local.get $current|16
      i32.le_s
      if
       local.get $colMonotonicity
       i32.const 1
       i32.add
       local.set $colMonotonicity
      end
 ...
 (func $assembly/index/getAIHint (param $board i32) (param $size i32) (result i32)
  (local $bestScore i32)
  (local $bestDirection i32)
  (local $direction i32)
  (local $boardCopy i32)
  (local $moved i32)
  (local $score i32)
 ...
 (func $export:assembly/index/isValidMove (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  ...
  local.get $1
  local.get $2
  call $assembly/index/isValidMove
  local.set $3
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
